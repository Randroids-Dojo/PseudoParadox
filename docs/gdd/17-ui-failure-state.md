...
- 2026-05-14: F-023 audio and motion controls. Added persistent player-facing Mute and Reduce motion controls, routed mute through the audio master gain, and made reduced motion skip win-screen fade and knockout easing. Files: `src/render/playerSettings.ts`, `src/app.ts`, `tests/render/playerSettings.test.ts`, `docs/FOLLOWUPS.md`, `docs/PLAYTEST.md`, `docs/PROGRESS_LOG.md`. PR pending.
