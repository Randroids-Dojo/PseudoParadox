...
- PR / Dot reference (when picked up): TBD. Current slice drafts `09-mechanic-instance-replay.md` and `17-ui-failure-state.md`; remaining legacy-root-only visual sections can stay as future F-002 cleanup.
