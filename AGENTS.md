...
Shared rules for every agentic coding tool working in Pseudo Paradox. Claude Code, Codex, Cursor, and any future agent: this file is mandatory reading before you write anything.
...
The Game Design Document at `docs/gdd/` is the source of truth for what Pseudo Paradox is. Before proposing architecture, adding features, or changing data schemas, read it. If the GDD and your idea disagree, the GDD wins unless explicitly approved.
...
Vite + TypeScript + Three.js + Rapier3D (WASM)
